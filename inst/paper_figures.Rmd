...
local_plot_scatter <- function(log2fc_df,
  ...
  # class_colors <- pals::glasbey(32)
  # class_colors <- Polychrome::createPalette(32, seedcolors = c("#ff0000", "#00ff00", "#0000ff"))
...
# Make figure2
topRow <- cowplot::plot_grid(dist, miss, ncol = 2, labels = 'AUTO', label_size = 22,
                             hjust = 0, vjust = 1.1)
...
spsUtil::quiet({
  network <- local_plot_network(log2FC(processMetabObj), metabolite_text_size = 3.5,
                                connection_width = 1.8, pathway_text_size = 6, pathway_width = 5, color_scale = "gradient", gradient_colors = c("blue", "white", "red"))
